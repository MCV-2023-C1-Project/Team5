...
QUERY_IMG_DIR = Path(r"C:\Users\krupa\Desktop\qsd1_w3\qsd1_w3")
REF_IMG_DIR = Path(r"D:\C1-Project (LEGACY)\data\BBDD")
REF_CSV_PATH = Path(r"Week3\paintings_db.csv")
RESULT_OUT_PATH = Path("result.pkl")
...
DESCRIPTOR_FN = ArtistReader(TEXT_DETECTOR, image_to_string)
K = 10
DISTANCE_FN = Edit()
